...
var orders = [
  { id:'ORD-001', customer:'Maria Santos', date:'2026-03-018', time:'2:00 PM', contact: '09693554291', area:'Marilao',
   address:'123 Sampaguita St., Brgy. Loma de Gato, Marilao, Bulacan',
    items:'Party Packages 1 (Cookies & Cream, Rocky Road) x1', paid:4500, balance:4300, total:8600, status:'confirmed' },
  { id:'ORD-002', customer:'Juan Cruz', date:'2026-03-05', time:'10:00 AM', contact: '0997 911 6796', area:'Malolos',
...
function renderDashboard() {
  ...
  // orders table
  var ordersHtml = '<table class="data-table"><tr><th>ID</th><th>Customer</th><th>Date</th><th>Address</th><th>Contact</th><th>Items</th><th>Paid</th><th>Balance</th><th>Total</th><th>Status</th><th>Action</th></tr>';
  orders.filter(function(o) { return o.status !== 'cancelled'; }).forEach(function(o) {
    var canCancel = canCancelOrder(o);
    ordersHtml += '<tr><td>' + o.id + '</td><td>' + o.customer + '</td><td>' + o.date + '</td>' + '<td>' + o.address + '</td><td>' + o.contact + 
      '</td><td style="max-width:150px;">' + o.items + '</td>' + '<td>' +'₱'+ (o.paid || 0).toLocaleString() + '</td>' + '<td>' +'₱' + (o.balance || 0).toLocaleString() + '</td>' +
